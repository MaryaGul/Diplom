...
type Props = {
  ...
  className?: string; // Добавлено свойство className
};
...
const Color = ({
  ...
  <div className={`flex flex-col gap-3 border-b border-primary-grey-200 p-5 ${className}`}>
    ...
    >
      ...
      />
      <Label className='flex-1 min-w-[60px] text-ellipsis overflow-hidden'>{attribute}</Label>
